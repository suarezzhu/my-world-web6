...
const requestAnimFrame = (function() {
  ...
  return window.requestAnimationFrame || window.requestAnimationFrame || (window as any).mozRequestAnimationFrame || function(callback) { window.setTimeout(callback, 1000 / 60) }
})()
